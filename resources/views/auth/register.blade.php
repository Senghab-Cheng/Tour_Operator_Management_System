<x-guest-layout>
    <h2 class="font-display text-2xl text-trail-900 mb-1">Create your account</h2>
    <p class="text-sm text-trail-900/60 mb-6">Start planning your next trip.</p>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <p class="text-center text-sm text-trail-900/60">
            ...
            <a href="{{ route('login') }}" class="font-medium text-trail-600 hover:text-trail-700">{{ __('Sign in') }}</a>
        </p>
    </form>
</x-guest-layout>